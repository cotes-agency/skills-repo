...
## Overview
The Business Model Canvas (BMC) is a one-page strategic tool that maps every element of how your business works. For a Micro-Agency (2-person founding team), the standard BMC needs one critical addition: a Time & Energy block, because your scarcest resource isn't money — it's the combined time of your small team. This playbook walks you through filling every block, validating the connections between them, and finding the weaknesses before the market does.
...
- Identify which channels are owned (blog, email list, social following), earned (word-of-mouth, reviews, press), or paid (ads). Aim for a mix, but as a Micro-Agency, owned and earned channels are your lifeline.
...
As a Micro-Agency, self-service and automated are your scaling levers. One-to-one doesn't scale but can be your revenue bridge while building.
...
List ALL revenue streams. Most successful Micro-Agencies have 2-3 streams (e.g., a SaaS product + a consulting arm + a digital course).

### Block 6: Key Resources
**Question:** What do you need to deliver your value proposition?

As a Micro-Agency, resources are: the combined time of your founding team, your skills, tools/software, and any intellectual property or data you have.
...
**Micro-Agency time-check:** Estimate hours per week for each activity. If the total exceeds your teams available hours (realistically 60-80 combined for a 2-person operation), something must be cut, automated, or outsourced.

### Block 8: Key Partnerships
**Question:** What external relationships reduce risk or fill capability gaps?

Partnerships for a Micro-Agency often include:
...
### Block 10 (Micro-Agency Team Addition): Time & Energy Budget
**Question:** Can YOU actually do all of this without burning out?

This block doesn't exist in the standard BMC but is the #1 killer of small businesses heavily reliant on their founders.
